...
'''s_box = [        # modified sbox for grp code (2,9)
    [0x63, 0x7C, 0x77, 0x7B, 0xF2, 0x6B, 0x6F, 0xC5, 0x30, 0x01, 0x67, 0x2B, 0xFE, 0xD7, 0xAB, 0x76],
    [0xCA, 0x82, 0xC9, 0x7D, 0xFA, 0x59, 0x47, 0xF0, 0xAD, 0xD4, 0xA2, 0xAF, 0x9C, 0xA4, 0x72, 0xC0],
    [0xB7, 0xFD, 0x93, 0x26, 0x36, 0x3F, 0xF7, 0xCC, 0x34, 0xA5, 0xE5, 0xF1, 0x71, 0xD8, 0x31, 0x15],
    [0x04, 0xC7, 0x23, 0xC3, 0x18, 0x96, 0x05, 0x9A, 0x07, 0x12, 0x80, 0xE2, 0xEB, 0x27, 0xB2, 0x75],
...
rci = ["0x92","0x3f","0x7e","0xfc","0xe3","0xdd","0xa1","0x59","0xb2","0x7f"]
mul2 = [
...
plainText = input("Enter plain text in 16 bytes without any space: ")    # takes hex code as string
key = input("Enter key in 16 bytes without any space: ")

#plainText='00112233445566778899aabbccddeeff'     #sample input and key
...
f=[]
fk=[]
for i in range(4):      # convert input into hex form
    l=[]
    lk=[]
    for j in range(4):
        s='0x'+plainText[total]+plainText[total+1]
        sk='0x'+key[total]+key[total+1]
        l.append(s)
        lk.append(sk) 
        total+=2
    #print(l)
...
printCipher(initialKey)
print("-------------------------")
print("---------Round 0---------")
print("This round key: ")
printCipher(initialKey)
print("This round output:")
...
k=0
while k<=(len(plainText)-1):
    print(plainText[k].upper()+plainText[k+1].upper(),end=' ')
    k+=2
print(' ')
#printtext(finalState)
